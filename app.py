...
with tab1:
    ...
    if v_no:
        ...
        if not my_data.empty:
            ...
            st.link_button("🚕 예상 택시비 확인", f"https://map.naver.com/v5/directions/서울시립대학교/,,{urllib.parse.quote(me['고사장'])}/-/car", use_container_width=True)
